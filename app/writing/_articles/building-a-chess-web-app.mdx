...
preview: "In this article, we will be building a Chess application using React that will allow the player to drag pieces across the board. We'll be using TailwindCSS for styling. To view what we will be building by the end of this article, visit dankibiwott.com/experiments/0001."
published: "yes"
...
<a
    href="https://dankibiwott.com/experiments/0001"
    target="_blank"
    rel="noopener noreferrer"
    className="text-link hover:underline hover:underline-offset-4"
> dankibiwott.com/experiments/0001
</a>.
